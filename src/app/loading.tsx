      ...
      <div className="loader-inner w-full h-full flex flex-col justify-between p-6 md:p-12">
        ...
        <div className="flex justify-between items-start">
          <div className="flex flex-col gap-1">
            ...
            <span style={{ color: "#00f2fe" }} className="text-[9px]">
              ID: 00-AF-92-X1
            </span>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-end border-t border-[#a8c1cf]/10 pt-6">
          <div className="flex flex-col gap-1">
            {["SEC_BOOT_SEQUENCE", "DYNA_ALLOC_MEM", "VIRTUAL_DOM_SYNC"].map(
              (txt, i) => (
          ...
          <div className="flex flex-col items-center">
            <div className="w-full h-[1px] bg-[#a8c1cf]/10 relative overflow-hidden">
              <div
                className="absolute inset-0 bg- origin-left animate-progress"
                style={{ animation: "progress 3s linear forwards" }}
              />
            </div>
            <span className="text-[9px] mt-2" style={{ color: "#a8c1cf" }}>
              CORE_STABILITY: 100%
            </span>
          </div>
