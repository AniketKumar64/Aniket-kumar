    ...
    >
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="about-reveal mb-20 flex flex-col md:flex-row justify-between items-baseline gap-4">
          <h2 className="text-[10px] uppercase tracking-[0.8em] text-primary font-bold">
            01 — LOG_PHILOSOPHY
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24">
          ...
          <div className="lg:col-span-8 about-reveal">
            <h3 className="text-3xl md:text-5xl font-light leading-tight tracking-tight">
              I build systems where <span className="text-primary italic">computational precision</span> meets <span className="font-bold">human-centric design.</span> Digital luxury isn't a style; it's a performance benchmark.
            </h3>
            {/* The Scanner-style Line */}
            <div className="about-line h-[1px] w-full bg-gradient-to-r from-primary to-transparent my-12 opacity-50" />
          </div>

          {/* Secondary Details */}
          <div className="lg:col-span-4 space-y-12 about-reveal">
            <div className="space-y-4">
              <h4 className="text-[10px] uppercase tracking-widest text-primary font-bold">The Methodology</h4>
            ...
            <div className="space-y-4">
              <h4 className="text-[10px] uppercase tracking-widest text-primary font-bold">Core Stack</h4>
      ...
      <div className="flex flex-col md:flex-row md:items-center gap-8 pt-6 relative">
        ...
        <div className="brand-line absolute left-0 top-6 w-[1px] h-20 bg-primary/20" />
        ...
        <div className="brand-text flex flex-col pl-8">
          ...
          <span className="text-[9px] uppercase tracking-[0.5em] text-primary font-mono mt-1">
        ...
        <div className="flex items-center gap-4 pl-8 md:pl-0">
          {socials.map((link, i) => (
            <a
              ...
              className="social-icon group relative p-3 border border-[#d6e4ff]/10 bg-white/[0.02] hover:border-primary/50 transition-all duration-500"
            >
      ...
      <div className="absolute -right-10 -bottom-10 opacity-[0.03] pointer-events-none select-none text-[25vw] font-black leading-none text-primary">
        DATA
      </div>
